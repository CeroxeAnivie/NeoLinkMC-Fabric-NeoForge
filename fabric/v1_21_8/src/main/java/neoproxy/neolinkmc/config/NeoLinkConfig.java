...
/**
 * Fabric-facing compatibility facade for Minecraft-specific enum conversion.
 *
 * <p>All persistence and primitive validation live in common. This class exists
 * only because the GUI naturally works with Mojang's {@link GameType} enum.</p>
 */
public final class NeoLinkConfig {
    ...
    public static final String DEFAULT_ONLINE_MODE = SharedNeoLinkConfig.DEFAULT_ONLINE_MODE;
